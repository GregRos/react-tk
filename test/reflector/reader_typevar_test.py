...
class Reader_TypeVar_Test:
    ...
    def it_reports_name(self, reader, expected):
    ...
    def it_reports_bound_value(self, reader, expected):
    ...
    def it_reports_default(self, reader, expected):
    ...
    def it_stringifies(self, reader, expected):
    ...
    def it_compares_similarity(self, reader, other, expected):
    ...
    def it_shows_type_arg_str(self, reader, expected):
        assert str(reader) == f"⟪ {expected} ⟫"
