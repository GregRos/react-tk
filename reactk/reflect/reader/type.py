...
from reactk.reflect.accessor.type import (
    MetadataAccessor,
    OrigBasesAccessor,
    UnderscoreNameAccessor,
)
from reactk.reflect.reader.base import Reader_Base
...
if TYPE_CHECKING:
    from reactk.reflect.reader.generic import SomeTypeVarReader, Reader_Generic
    ...
    def is_required(self) -> bool:
        ...
        match t.name:
            ...
            case "Annotated" | "Unpack":
                ...
                from reactk.reflect.reader.generic import is_not_bound
